                    ...
                    <form method="POST" action="{{ route('acte.naissance.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" id="nom_enfant" name="nom_enfant" value="{{ old('nom_enfant') }}"
                                       class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                                       required>
                                @error('nom_enfant')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="text" id="prenom_enfant" name="prenom_enfant" value="{{ old('prenom_enfant') }}"
                                       class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                                       required>
                                @error('prenom_enfant')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <select id="sexe_enfant" name="sexe_enfant"
                                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                                        required>
                                    <option value="masculin" {{ old('sexe_enfant') == 'masculin' ? 'selected' : '' }}>Masculin</option>
                                    <option value="féminin" {{ old('sexe_enfant') == 'féminin' ? 'selected' : '' }}>Féminin</option>
                                </select>
                                @error('sexe_enfant')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="time" id="heure_de_naissance" name="heure_de_naissance" value="{{ old('heure_de_naissance') }}"
                                       class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                                       required>
                            ...
                            <div>
                                ...
                                <input type="text" id="nom_et_prenom_pere" name="nom_et_prenom_pere" value="{{ old('nom_et_prenom_pere') }}"
                                       class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                                       required>
                            ...
                            <div>
                                ...
                                <input type="text" id="nom_et_prenom_mere" name="nom_et_prenom_mere" value="{{ old('nom_et_prenom_mere') }}"
                                       class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                                       required>
